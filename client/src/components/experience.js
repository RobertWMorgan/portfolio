  ...
  return (
    <div className='content' id='experience'>
      ...
      <div className='experience-card'>
        ...
        <ul>
          <li>
            Oversee key-word research, meta-titles and alt-text.
          </li>
          <li>
            Assist with QA process and implementation of new website features.
          </li>
          <li>
            Led case study reports and creation of new product pages to be
            published on website by collaborating with sales teams and
            contacting customers.
          </li>
          <li>
            Photographed new product installations.
          </li>
        </ul>
      </div>
    </div>
